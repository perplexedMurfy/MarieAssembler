...
extern inline int CompareStrToKeyword(char *Str, int FileKeywordLength, const keyword_entry Keyword) {
...
extern inline int WriteProgramData(file_state *File, uint16_t Data, int CurrentAddress, uint8_t ProgramMetaDataFlags) {
	int Success = FALSE;
